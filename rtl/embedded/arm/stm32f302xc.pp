...
procedure USB_HP_CAN_TX_IRQHandler; external name 'USB_HP_CAN_TX_IRQHandler';
procedure USB_LP_CAN_RX0_IRQHandler; external name 'USB_LP_CAN_RX0_IRQHandler';
...
procedure COMP1_2_IRQHandler; external name 'COMP1_2_IRQHandler';
...
procedure USBWakeUp_RMP_IRQHandler; external name 'USBWakeUp_RMP_IRQHandler';
...
asm
  ...
  .set USB_HP_CAN_TX_IRQHandler, Haltproc
  .set USB_LP_CAN_RX0_IRQHandler, Haltproc
