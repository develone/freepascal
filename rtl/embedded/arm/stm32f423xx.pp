...
const
  ...
  CAN3_BASE     = APB1PERIPH_BASE + $6C00;
  ...
  UART9_BASE    = APB2PERIPH_BASE + $1800;
  UART10_BASE   = APB2PERIPH_BASE + $1C00;
  ...
  DFSDM2_BASE   = APB2PERIPH_BASE + $6400;
  ...
  DFSDM2_Channel2_BASE= DFSDM2_BASE + $40;
  DFSDM2_Channel3_BASE= DFSDM2_BASE + $60;
  DFSDM2_Channel4_BASE= DFSDM2_BASE + $80;
  DFSDM2_Channel5_BASE= DFSDM2_BASE + $A0;
  DFSDM2_Channel6_BASE= DFSDM2_BASE + $C0;
  DFSDM2_Channel7_BASE= DFSDM2_BASE + $E0;
  DFSDM2_Filter0_BASE= DFSDM2_BASE + $100;
  DFSDM2_Filter1_BASE= DFSDM2_BASE + $180;
  DFSDM2_Filter2_BASE= DFSDM2_BASE + $200;
  DFSDM2_Filter3_BASE= DFSDM2_BASE + $280;
  ...
  AES_BASE      = AHB2PERIPH_BASE + $60000;
...
var
  ...
  CAN3          : TCAN_Registers absolute CAN3_BASE;
  ...
  UART10        : TUSART_Registers absolute UART10_BASE;
  ...
  DFSDM2_Channel2: TDFSDM_Channel_Registers absolute DFSDM2_Channel2_BASE;
  DFSDM2_Channel3: TDFSDM_Channel_Registers absolute DFSDM2_Channel3_BASE;
  DFSDM2_Channel4: TDFSDM_Channel_Registers absolute DFSDM2_Channel4_BASE;
  DFSDM2_Channel5: TDFSDM_Channel_Registers absolute DFSDM2_Channel5_BASE;
  DFSDM2_Channel6: TDFSDM_Channel_Registers absolute DFSDM2_Channel6_BASE;
  DFSDM2_Channel7: TDFSDM_Channel_Registers absolute DFSDM2_Channel7_BASE;
  DFSDM2_Filter0: TDFSDM_Filter_Registers absolute DFSDM2_Filter0_BASE;
  DFSDM2_Filter1: TDFSDM_Filter_Registers absolute DFSDM2_Filter1_BASE;
  DFSDM2_Filter2: TDFSDM_Filter_Registers absolute DFSDM2_Filter2_BASE;
  DFSDM2_Filter3: TDFSDM_Filter_Registers absolute DFSDM2_Filter3_BASE;
...
procedure CAN3_TX_IRQHandler; external name 'CAN3_TX_IRQHandler';
procedure CAN3_RX0_IRQHandler; external name 'CAN3_RX0_IRQHandler';
procedure CAN3_RX1_IRQHandler; external name 'CAN3_RX1_IRQHandler';
procedure CAN3_SCE_IRQHandler; external name 'CAN3_SCE_IRQHandler';
...
procedure UART10_IRQHandler; external name 'UART10_IRQHandler';
...
procedure DFSDM2_FLT0_IRQHandler; external name 'DFSDM2_FLT0_IRQHandler';
procedure DFSDM2_FLT1_IRQHandler; external name 'DFSDM2_FLT1_IRQHandler';
procedure DFSDM2_FLT2_IRQHandler; external name 'DFSDM2_FLT2_IRQHandler';
procedure DFSDM2_FLT3_IRQHandler; external name 'DFSDM2_FLT3_IRQHandler';
...
asm
  ...
  .long DFSDM2_FLT0_IRQHandler
  .long DFSDM2_FLT1_IRQHandler
  .long DFSDM2_FLT2_IRQHandler
  .long DFSDM2_FLT3_IRQHandler
  ...
  .set CAN3_TX_IRQHandler, Haltproc
  .set CAN3_RX0_IRQHandler, Haltproc
  .set CAN3_RX1_IRQHandler, Haltproc
  .set CAN3_SCE_IRQHandler, Haltproc
  ...
  .set UART10_IRQHandler, Haltproc
  ...
  .set DFSDM2_FLT0_IRQHandler, Haltproc
  .set DFSDM2_FLT1_IRQHandler, Haltproc
  .set DFSDM2_FLT2_IRQHandler, Haltproc
  .set DFSDM2_FLT3_IRQHandler, Haltproc
