...
type
  ...
  TFLASH_Registers = record
    ...
    WRP2AR      : longword;
    WRP2BR      : longword;
    RESERVED3   : array[0..54] of longword;
    CFGR        : longword;
    RESERVED4   : array[0..50] of longword;
    DSR         : longword;
  end;
  ...
  TOCTOSPI_Registers = record
    ...
    LPTR        : longword;
    RESERVED13  : array[0..18] of longword;
    WCCR        : longword;
    RESERVED14  : longword;
    WTCR        : longword;
    RESERVED15  : longword;
    ...
    WABR        : longword;
    RESERVED17  : array[0..22] of longword;
    HLCR        : longword;
  end;

  TOCTOSPIM_Registers = record
    CR          : longword;
    PCR         : array[0..1] of longword;
  end;
...
const
  ...
  FMC_R_BASE    = $A0000000;
  OCTOSPI1_R_BASE= $A0001000;
  OCTOSPI2_R_BASE= $A0001400;
  ...
  PSSI_BASE     = AHB2PERIPH_BASE + $08050400;
  PKA_BASE      = AHB2PERIPH_BASE + $0805E000;
  ...
  SDMMC2_BASE   = AHB2PERIPH_BASE + $08062800;
...
procedure HASH_CRS_IRQHandler; external name 'HASH_CRS_IRQHandler';
...
asm
  ...
  .set HASH_CRS_IRQHandler, Haltproc
