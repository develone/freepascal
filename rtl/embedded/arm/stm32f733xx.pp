...
type
  ...
  TUSB_HS_PHYC_Global_Registers = record
    USB_HS_PHYC_PLL : longword;
    Reserved04  : longword;
    Reserved08  : longword;
    USB_HS_PHYC_TUNE : longword;
    Reserved10  : longword;
    Reserved14  : longword;
    USB_HS_PHYC_LDO : longword;
  end;
...
const
  ...
  UID_BASE      = $1FF07A10;
  FLASHSIZE_BASE= $1FF07A22;
  PACKAGE_BASE  = $1FF07BF0;
  ...
  USB_HS_PHYC_CONTROLLER_BASE= $40017C00;
