...
type
  ...
  TFLASH_Registers = record
    ...
    OPTR        : longword;
    WRPR        : longword;
    RESERVED1   : array[0..22] of longword;
    WRPR2       : longword;
  end;
...
const
  ...
  DATA_EEPROM_BANK2_BASE= $08080C00;
  SRAM_BASE     = $20000000;
  ...
  I2C3_BASE     = APBPERIPH_BASE + $00007800;
  ...
  GPIOE_BASE    = IOPPERIPH_BASE + $00001000;
...
procedure USART4_5_IRQHandler; external name 'USART4_5_IRQHandler';
...
procedure I2C3_IRQHandler; external name 'I2C3_IRQHandler';
...
procedure AES_LPUART1_IRQHandler; external name 'AES_LPUART1_IRQHandler';
...
asm
  ...
  .set USART4_5_IRQHandler, Haltproc
  ...
  .set AES_LPUART1_IRQHandler, Haltproc
