...
const
  ...
  CAN3_BASE     = APB1PERIPH_BASE + $3400;
  ...
  SDMMC2_BASE   = APB2PERIPH_BASE + $1C00;
  ...
  LTDC_Layer1_BASE= LTDC_BASE + $0084;
  LTDC_Layer2_BASE= LTDC_BASE + $0104;
  DSI_BASE      = APB2PERIPH_BASE + $6C00;
  DFSDM1_BASE   = APB2PERIPH_BASE + $7400;
  ...
  MDIOS_BASE    = APB2PERIPH_BASE + $7800;
  ...
  UID_BASE      = $1FF0F420;
  FLASHSIZE_BASE= $1FF0F442;
  PACKAGE_BASE  = $1FF0F7E0;
  PACKAGESIZE_BASE= PACKAGE_BASE;
  ...
  JPEG_BASE     = AHB2PERIPH_BASE + $51000;
  ...
  USB_OTG_GLOBAL_BASE= $0000;
  USB_OTG_DEVICE_BASE= $0800;
  USB_OTG_IN_ENDPOINT_BASE= $0900;
  USB_OTG_OUT_ENDPOINT_BASE= $0B00;
  USB_OTG_HOST_BASE= $0400;
  USB_OTG_HOST_PORT_BASE= $0440;
  USB_OTG_HOST_CHANNEL_BASE= $0500;
  USB_OTG_PCGCCTL_BASE= $0E00;
...
var
  ...
  ADC123_COMMON : TADC_Common_Registers absolute ADC_BASE;
  ...
  JPEG          : TJPEG_Registers absolute JPEG_BASE;
