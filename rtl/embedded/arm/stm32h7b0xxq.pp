...
const
  ...
  CRYP_BASE     = CD_AHB2PERIPH_BASE + $1000;
  HASH_BASE     = CD_AHB2PERIPH_BASE + $1400;
  HASH_DIGEST_BASE= CD_AHB2PERIPH_BASE + $1710;
  ...
  OTFDEC1_BASE  = CD_AHB3PERIPH_BASE + $B800;
  ...
  OTFDEC2_BASE  = CD_AHB3PERIPH_BASE + $BC00;
