...
type
  ...
  TRCC_Core_Registers = record
    ...
    APB2LPENR   : longword;
    APB4LPENR   : longword;
    RESERVED10  : array[0..3] of longword;
  end;
...
const
  ...
  ART_BASE      = D2_AHB1PERIPH_BASE + $4400;
  ...
  RCC_C1_BASE   = RCC_BASE + $130;
  RCC_C2_BASE   = RCC_BASE + $190;
  ...
  WWDG2_BASE    = D2_APB1PERIPH_BASE + $2C00;
  ...
  IWDG2_BASE    = D3_APB1PERIPH_BASE + $4C00;
...
var
  ...
  WWDG2         : TWWDG_Registers absolute WWDG2_BASE;
  IWDG2         : TIWDG_Registers absolute IWDG2_BASE;
  ...
  RCC_C1        : TRCC_Core_Registers absolute RCC_C1_BASE;
  RCC_C2        : TRCC_Core_Registers absolute RCC_C2_BASE;
  ART           : TART_Registers absolute ART_BASE;
...
procedure CM7_SEV_IRQHandler; external name 'CM7_SEV_IRQHandler';
procedure CM4_SEV_IRQHandler; external name 'CM4_SEV_IRQHandler';
...
procedure HSEM2_IRQHandler; external name 'HSEM2_IRQHandler';
...
procedure HOLD_CORE_IRQHandler; external name 'HOLD_CORE_IRQHandler';
...
asm
  ...
  .long CM7_SEV_IRQHandler
  .long CM4_SEV_IRQHandler
  .long 0
  .long 0
  ...
  .set CM7_SEV_IRQHandler, Haltproc
  .set CM4_SEV_IRQHandler, Haltproc
  ...
  .set HOLD_CORE_IRQHandler, Haltproc
