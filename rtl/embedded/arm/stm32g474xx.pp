...
type
  ...
  THRTIM_Registers = record
    ...
    sTimerxRegs : array[0..5] of THRTIM_Timerx_Registers;
...
const
  ...
  FDCAN2_BASE   = APB1PERIPH_BASE + $6800;
  FDCAN3_BASE   = APB1PERIPH_BASE + $6C00;
  ...
  COMP5_BASE    = APB2PERIPH_BASE + $0210;
  COMP6_BASE    = APB2PERIPH_BASE + $0214;
  COMP7_BASE    = APB2PERIPH_BASE + $0218;
  ...
  OPAMP4_BASE   = APB2PERIPH_BASE + $030C;
  OPAMP5_BASE   = APB2PERIPH_BASE + $0310;
  OPAMP6_BASE   = APB2PERIPH_BASE + $0314;
  ...
  SPI4_BASE     = APB2PERIPH_BASE + $3C00;
  TIM15_BASE    = APB2PERIPH_BASE + $4000;
  TIM16_BASE    = APB2PERIPH_BASE + $4400;
  TIM17_BASE    = APB2PERIPH_BASE + $4800;
  TIM20_BASE    = APB2PERIPH_BASE + $5000;
  SAI1_BASE     = APB2PERIPH_BASE + $5400;
  SAI1_Block_A_BASE= SAI1_BASE + $0004;
  SAI1_Block_B_BASE= SAI1_BASE + $0024;
  HRTIM1_BASE   = APB2PERIPH_BASE + $6800;
  HRTIM1_TIMA_BASE= HRTIM1_BASE + $0080;
  HRTIM1_TIMB_BASE= HRTIM1_BASE + $0100;
  HRTIM1_TIMC_BASE= HRTIM1_BASE + $0180;
  HRTIM1_TIMD_BASE= HRTIM1_BASE + $0200;
  HRTIM1_TIME_BASE= HRTIM1_BASE + $0280;
  HRTIM1_TIMF_BASE= HRTIM1_BASE + $0300;
  HRTIM1_COMMON_BASE= HRTIM1_BASE + $0380;
  ...
  DMA1_Channel8_BASE= DMA1_BASE + $0094;
  ...
  DMA2_Channel8_BASE= DMA2_BASE + $0094;
  ...
  ADC3_BASE     = AHB2PERIPH_BASE + $08000400;
  ADC4_BASE     = AHB2PERIPH_BASE + $08000500;
  ADC5_BASE     = AHB2PERIPH_BASE + $08000600;
  ADC345_COMMON_BASE= AHB2PERIPH_BASE + $08000700;
  DAC_BASE      = AHB2PERIPH_BASE + $08000800;
  DAC1_BASE     = AHB2PERIPH_BASE + $08000800;
  DAC2_BASE     = AHB2PERIPH_BASE + $08000C00;
  DAC3_BASE     = AHB2PERIPH_BASE + $08001000;
  DAC4_BASE     = AHB2PERIPH_BASE + $08001400;
...
var
  ...
  OPAMP5        : TOPAMP_Registers absolute OPAMP5_BASE;
  OPAMP6        : TOPAMP_Registers absolute OPAMP6_BASE;
  ...
  HRTIM1_TIMF   : THRTIM_Timerx_Registers absolute HRTIM1_TIMF_BASE;
  ...
  ADC5          : TADC_Registers absolute ADC5_BASE;
  ADC345_COMMON : TADC_Common_Registers absolute ADC345_COMMON_BASE;
  ...
  DAC4          : TDAC_Registers absolute DAC4_BASE;
  ...
  DMA1_Channel8 : TDMA_Channel_Registers absolute DMA1_Channel8_BASE;
  ...
  DMA2_Channel8 : TDMA_Channel_Registers absolute DMA2_Channel8_BASE;
...
procedure TIM7_DAC_IRQHandler; external name 'TIM7_DAC_IRQHandler';
...
procedure ADC5_IRQHandler; external name 'ADC5_IRQHandler';
...
procedure HRTIM1_TIMF_IRQHandler; external name 'HRTIM1_TIMF_IRQHandler';
...
procedure DMA1_Channel8_IRQHandler; external name 'DMA1_Channel8_IRQHandler';
...
procedure DMA2_Channel8_IRQHandler; external name 'DMA2_Channel8_IRQHandler';
...
asm
  ...
  .set TIM7_DAC_IRQHandler, Haltproc
  ...
  .set HRTIM1_TIMF_IRQHandler, Haltproc
  ...
  .set DMA1_Channel8_IRQHandler, Haltproc
  .set DMA2_Channel6_IRQHandler, Haltproc
  .set DMA2_Channel7_IRQHandler, Haltproc
  .set DMA2_Channel8_IRQHandler, Haltproc
