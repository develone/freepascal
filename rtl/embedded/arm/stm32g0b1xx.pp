...
type
  TIRQn_Enum = (
    ...
    TIM14_IRQn  = 19,                 
    TIM15_IRQn  = 20,                 
    TIM16_FDCAN_IT0_IRQn = 21,        
    TIM17_FDCAN_IT1_IRQn = 22,        
    I2C1_IRQn   = 23,                 
    I2C2_3_IRQn = 24,                 
    SPI1_IRQn   = 25,                 
    SPI2_3_IRQn = 26,                 
  ...
  TFLASH_Registers = record
    ...
    PCROP2BSR   : longword;
    PCROP2BER   : longword;
    RESERVED7   : array[0..8] of longword;
    SECR        : longword;
  end;
...
const
  ...
  FDCAN1_BASE   = APBPERIPH_BASE + $00006400;
  FDCAN_CONFIG_BASE= APBPERIPH_BASE + $00006500;
  FDCAN2_BASE   = APBPERIPH_BASE + $00006800;
  ...
  LPUART2_BASE  = APBPERIPH_BASE + $00008400;
  ...
  SRAMCAN_BASE  = APBPERIPH_BASE + $0000B400;
...
var
  ...
  LPUART2       : TUSART_Registers absolute LPUART2_BASE;
  ...
  COMP23_COMMON : TCOMP_Common_Registers absolute COMP2_BASE;
...
procedure PVD_VDDIO2_IRQHandler; external name 'PVD_VDDIO2_IRQHandler';
...
procedure USB_UCPD1_2_IRQHandler; external name 'USB_UCPD1_2_IRQHandler';
...
procedure TIM16_FDCAN_IT0_IRQHandler; external name 'TIM16_FDCAN_IT0_IRQHandler';
procedure TIM17_FDCAN_IT1_IRQHandler; external name 'TIM17_FDCAN_IT1_IRQHandler';
...
procedure USART2_LPUART2_IRQHandler; external name 'USART2_LPUART2_IRQHandler';
procedure USART3_4_5_6_LPUART1_IRQHandler; external name 'USART3_4_5_6_LPUART1_IRQHandler';
...
asm
  ...
  .long TIM16_FDCAN_IT0_IRQHandler
  .long TIM17_FDCAN_IT1_IRQHandler
  ...
  .long USART3_4_5_6_LPUART1_IRQHandler
  .long CEC_IRQHandler
  ...
  .set PVD_VDDIO2_IRQHandler, Haltproc
  ...
  .set USB_UCPD1_2_IRQHandler, Haltproc
  ...
  .set TIM16_FDCAN_IT0_IRQHandler, Haltproc
  .set TIM17_FDCAN_IT1_IRQHandler, Haltproc
  ...
  .set USART2_LPUART2_IRQHandler, Haltproc
  .set USART3_4_5_6_LPUART1_IRQHandler, Haltproc
