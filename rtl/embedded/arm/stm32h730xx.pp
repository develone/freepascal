...
type
  ...
  TADC_Registers = record
    ...
    RESERVED8   : longword;
    RESERVED9   : longword;
    LTR2_DIFSEL : longword;
    HTR2_CALFACT : longword;
    LTR3_RES10  : longword;
    HTR3_RES11  : longword;
    DIFSEL_RES12 : longword;
    CALFACT_RES13 : longword;
    CALFACT2_RES14 : longword;
  end;
  ...
  TDBGMCU_Registers = record
    ...
    RESERVED8   : longword;
    APB4FZ1     : longword;
    RESERVED9   : array[0..989] of longword;
    PIDR4       : longword;
  ...
  TSYSCFG_Registers = record
    ...
    PKGR        : longword;
    RESERVED5   : array[0..117] of longword;
    UR0         : longword;
    UR1         : longword;
    UR2         : longword;
    UR3         : longword;
  ...
  TOTFDEC_Region_Registers = record
    REG_CONFIGR : longword;
    REG_START_ADDR : longword;
    REG_END_ADDR : longword;
    REG_NONCER0 : longword;
    REG_NONCER1 : longword;
    REG_KEYR0   : longword;
    REG_KEYR1   : longword;
    REG_KEYR2   : longword;
    REG_KEYR3   : longword;
  ...
  TOTFDEC_Registers = record
    CR          : longword;
    RESERVED1   : array[0..190] of longword;
    ISR         : longword;
    ICR         : longword;
    IER         : longword;
...
const
  ...
  D1_AXISRAM1_BASE= $24000000;
  D1_AXISRAM2_BASE= $24020000;
  D1_AXISRAM_BASE= D1_AXISRAM1_BASE;
  D2_AHBSRAM1_BASE= $30000000;
  D2_AHBSRAM2_BASE= $30004000;
  D2_AHBSRAM_BASE= D2_AHBSRAM1_BASE;
  ...
  OCTOSPI1_R_BASE= D1_AHB1PERIPH_BASE + $5000;
  DLYB_OCTOSPI1_BASE= D1_AHB1PERIPH_BASE + $6000;
  SDMMC1_BASE   = D1_AHB1PERIPH_BASE + $7000;
  DLYB_SDMMC1_BASE= D1_AHB1PERIPH_BASE + $8000;
  RAMECC1_BASE  = D1_AHB1PERIPH_BASE + $9000;
  OCTOSPI2_R_BASE= D1_AHB1PERIPH_BASE + $A000;
  DLYB_OCTOSPI2_BASE= D1_AHB1PERIPH_BASE + $B000;
  OCTOSPIM_BASE = D1_AHB1PERIPH_BASE + $B400;
  OTFDEC1_BASE  = D1_AHB1PERIPH_BASE + $B800;
  OTFDEC1_REGION1_BASE= OTFDEC1_BASE + $20;
  OTFDEC1_REGION2_BASE= OTFDEC1_BASE + $50;
  OTFDEC1_REGION3_BASE= OTFDEC1_BASE + $80;
  OTFDEC1_REGION4_BASE= OTFDEC1_BASE + $B0;
  OTFDEC2_BASE  = D1_AHB1PERIPH_BASE + $BC00;
  OTFDEC2_REGION1_BASE= OTFDEC2_BASE + $20;
  OTFDEC2_REGION2_BASE= OTFDEC2_BASE + $50;
  OTFDEC2_REGION3_BASE= OTFDEC2_BASE + $80;
  OTFDEC2_REGION4_BASE= OTFDEC2_BASE + $B0;
  ...
  PSSI_BASE     = D2_AHB2PERIPH_BASE + $0400;
  CRYP_BASE     = D2_AHB2PERIPH_BASE + $1000;
  HASH_BASE     = D2_AHB2PERIPH_BASE + $1400;
  HASH_DIGEST_BASE= D2_AHB2PERIPH_BASE + $1710;
  ...
  FMAC_BASE     = D2_AHB2PERIPH_BASE + $4000;
  CORDIC_BASE   = D2_AHB2PERIPH_BASE + $4400;
  ...
  I2C5_BASE     = D2_APB1PERIPH_BASE + $6400;
  ...
  FDCAN3_BASE   = D2_APB1PERIPH_BASE + $D400;
  TIM23_BASE    = D2_APB1PERIPH_BASE + $E000;
  TIM24_BASE    = D2_APB1PERIPH_BASE + $E400;
  ...
  UART9_BASE    = D2_APB2PERIPH_BASE + $1800;
  USART10_BASE  = D2_APB2PERIPH_BASE + $1C00;
  ...
  DFSDM1_BASE   = D2_APB2PERIPH_BASE + $7800;
  ...
  DTS_BASE      = D3_APB1PERIPH_BASE + $6800;
  ...
  RAMECC1_Monitor6_BASE= RAMECC1_BASE + $C0;
...
var
  ...
  I2C5          : TI2C_Registers absolute I2C5_BASE;
  FDCAN_CCU     : TFDCAN_ClockCalibrationUnit_Registers absolute FDCAN_CCU_BASE;
  TIM23         : TTIM_Registers absolute TIM23_BASE;
  TIM24         : TTIM_Registers absolute TIM24_BASE;
  ...
  OTFDEC1       : TOTFDEC_Registers absolute OTFDEC1_BASE;
  OTFDEC1_REGION1: TOTFDEC_Region_Registers absolute OTFDEC1_REGION1_BASE;
  OTFDEC1_REGION2: TOTFDEC_Region_Registers absolute OTFDEC1_REGION2_BASE;
  OTFDEC1_REGION3: TOTFDEC_Region_Registers absolute OTFDEC1_REGION3_BASE;
  OTFDEC1_REGION4: TOTFDEC_Region_Registers absolute OTFDEC1_REGION4_BASE;
  OTFDEC2       : TOTFDEC_Registers absolute OTFDEC2_BASE;
  OTFDEC2_REGION1: TOTFDEC_Region_Registers absolute OTFDEC2_REGION1_BASE;
  OTFDEC2_REGION2: TOTFDEC_Region_Registers absolute OTFDEC2_REGION2_BASE;
  OTFDEC2_REGION3: TOTFDEC_Region_Registers absolute OTFDEC2_REGION3_BASE;
  OTFDEC2_REGION4: TOTFDEC_Region_Registers absolute OTFDEC2_REGION4_BASE;
...
procedure OTFDEC1_IRQHandler; external name 'OTFDEC1_IRQHandler';
procedure OTFDEC2_IRQHandler; external name 'OTFDEC2_IRQHandler';
...
procedure I2C5_EV_IRQHandler; external name 'I2C5_EV_IRQHandler';
procedure I2C5_ER_IRQHandler; external name 'I2C5_ER_IRQHandler';
procedure FDCAN3_IT0_IRQHandler; external name 'FDCAN3_IT0_IRQHandler';
procedure FDCAN3_IT1_IRQHandler; external name 'FDCAN3_IT1_IRQHandler';
procedure TIM23_IRQHandler; external name 'TIM23_IRQHandler';
procedure TIM24_IRQHandler; external name 'TIM24_IRQHandler';
...
asm
  ...
  .long I2C5_EV_IRQHandler
  .long I2C5_ER_IRQHandler
  .long FDCAN3_IT0_IRQHandler
  .long FDCAN3_IT1_IRQHandler
  .long TIM23_IRQHandler
  .long TIM24_IRQHandler
  ...
  .set OTFDEC1_IRQHandler, Haltproc
  .set OTFDEC2_IRQHandler, Haltproc
  .set FMAC_IRQHandler, Haltproc
  .set CORDIC_IRQHandler, Haltproc
  .set UART9_IRQHandler, Haltproc
  .set USART10_IRQHandler, Haltproc
  .set I2C5_EV_IRQHandler, Haltproc
  .set I2C5_ER_IRQHandler, Haltproc
  .set FDCAN3_IT0_IRQHandler, Haltproc
  .set FDCAN3_IT1_IRQHandler, Haltproc
  .set TIM23_IRQHandler, Haltproc
  .set TIM24_IRQHandler, Haltproc
