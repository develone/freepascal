...
type
  TIRQn_Enum = (
    ...
    SERCOM6_1_IRQn            = 71,
    SERCOM6_2_IRQn            = 72,
    SERCOM6_OTHER_IRQn        = 73,
    SERCOM7_0_IRQn            = 74,
    SERCOM7_1_IRQn            = 75,
    SERCOM7_2_IRQn            = 76,
    SERCOM7_OTHER_IRQn        = 77,
    USB_OTHER_IRQn            = 80,
...
procedure SERCOM6_OTHER_Handler;    external name 'SERCOM6_OTHER_Handler';
...
procedure SERCOM7_OTHER_Handler;    external name 'SERCOM7_OTHER_Handler';
